...
# After model.fit() and evaluating accuracy
accuracy = model.score(X_test, y_test)  # already existing in your code
model_info = {"accuracy": accuracy}
joblib.dump(model_info, "model_info.joblib")  # Save it to file
